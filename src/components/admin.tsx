...
<PageTransition>
      <div className="flex flex-col justify-center items-center w-2/5 min-w-96 text-center text-2xl text-[#FFFFFF] gap-9 bg-black p-8 rounded-3xl border-[#302f2f] border">
        ...
        <form className="flex flex-col gap-3 space-y-7 items-center" onSubmit={(e) => handleSubmit(e, `${import.meta.env.VITE_BACKEND_URL}/loginlecturer`, home, navigate)}>
        ...
        <Link to="/user/lectureinter"> <button type='submit'
